...
\begin{ExerciseList}
    ...
    \Answer[ref={AGL}].
        \Question We see that the program has a serial fraction of 40\%. Therefore, we set $\mathbf{f} = 0.4$ and insert this into the formula specified by \nameref{Amdahl's Law}:
            ...
            \end{equation*}
        \Question Assuming best possible speedup, \nameref{Amdahl's Law} tells us the following holds true
            \begin{gather*}
                ...
                \mathbf{f} = \frac{1}{7}
            \end{gather*}
        \Question \nameref{Gustafson's Law} tells us the following holds true
            \begin{gather*}
